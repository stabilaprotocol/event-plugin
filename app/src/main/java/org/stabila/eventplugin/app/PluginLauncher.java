 ...
 */
package org.stabila.eventplugin.app;
...
import org.stabila.common.logsfilter.IPluginEventListener;
...
public class PluginLauncher {
    ...
    public static void main(String[] args) {
        String path = "/Users/stabila/sourcecode/eventplugin/build/plugins/plugin-mongodb-1.0.0.zip";
        ...
        eventListeners.forEach(listener -> {
            listener.setDBConfig("eventlog|stabila|123456");
        });
